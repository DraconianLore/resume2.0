  ...
  render() {
    return (
      <div className='section wider'>
        ...
        <h4 className='sub-heading'>Logistics Manager<span class="right-side">Feb 2016 - Dec 2018</span></h4>
        <h4 className='sub-sub-heading'>Big Mouth Foods Pty Ltd <span class="right-side">Sydney, NSW, Australia</span></h4>
        ...
        <hr className='exp-hr' />
        <h4 className='sub-heading'>Truck Manager <span class="right-side">May 2015 - Feb 2016</span></h4>
        <h4 className='sub-sub-heading'>Mama Linh's Food Trucks <span class="right-side">Sydney, NSW, Australia</span></h4>
        <ul>
